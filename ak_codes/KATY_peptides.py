...
import numpy as np
import random
import DataSets_peptides as ds
...
weights= {"PS":0.1,"TF":0.1,"CF":0.2,"BP":0.0,"MT":0.3,"GE":0.0}
additional_infos = [
...
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":[]} , 
    {"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":['Unique_peptides_narrow']}
    ,
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":['Unique_haplotypes_narrow']}, 
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":['Promiscuity_narrow']},
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":['Unique_peptides_narrow','Unique_haplotypes_narrow']} ,
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":['Unique_haplotypes_narrow','Promiscuity_narrow']},
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":['Unique_peptides_narrow','Promiscuity_narrow']},  

    {"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":True, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":["Unique_haplotypes_narrow","Unique_peptides_narrow","Promiscuity_narrow"]}
...
overall_results.to_csv("./data/Bruan_MutationExperiments_3pnarrow.tsv",sep = "\t",index = 0)
overall_results
...
draw_KM_curve_svm_experiment('survpeptidesnarrow_base_1',svm_params={'kernel':'poly'},additional_info={"PRIMARY_TUMOR_ONLY":False,"with_mutations":True,"hotspots":True, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv","HS_features":[]}) 


draw_KM_curve_svm_experiment('survpeptidesnarrow_pep_1',svm_params={'kernel':'poly'},additional_info={"PRIMARY_TUMOR_ONLY":False,"with_mutations":True,"hotspots":True, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv","HS_features":['Unique_peptides_narrow']})

draw_KM_curve_svm_experiment('survpeptidesnarrow_promis_1',svm_params={'kernel':'poly'},additional_info={"PRIMARY_TUMOR_ONLY":False,"with_mutations":True,"hotspots":True, "weights":weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv","HS_features":['Promiscuity_narrow']})

# In[10]:

#weights = {"PS": 0.1, "TF": 0.1, "CF": 0.1, "BP": 0.1, "MT": 0.1, "GE": 0.1}
draw_KM_curve_svm_experiment('survpeptidesnarrow_HLA_1',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":["Unique_haplotypes_narrow"]})
draw_KM_curve_svm_experiment('survpeptidesnarrow_HLApep_1',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":["Unique_haplotypes_narrow","Unique_peptides_narrow"]})
draw_KM_curve_svm_experiment('survpeptidesnarrow_HLApromis_1',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":["Unique_haplotypes_narrow","Promiscuity_narrow"]})

draw_KM_curve_svm_experiment('survpeptidesnarrow_prompep_1',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":["Promiscuity_narrow","Unique_peptides_narrow"]})


# In[6]:

draw_KM_curve_svm_experiment('survpeptidesnarrow_3_feat_1',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/braun_mutations_alternative_scoring_narrow_broad.tsv", "HS_features":["Unique_haplotypes_narrow","Unique_peptides_narrow","Promiscuity_narrow"]})
