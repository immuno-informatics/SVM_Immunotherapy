...
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":[]} , 
    {"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":['unique_peptides']}
    ,
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":['n_unique_HLA']}, 
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":['popcov_but_sqrt']},
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":['unique_peptides','n_unique_HLA']} ,
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":['n_unique_HLA','popcov_but_sqrt']},
{"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":False, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":['unique_peptides','popcov_but_sqrt']},  

    {"PRIMARY_TUMOR_ONLY":False,"with_mutations":True, "random_contigs":False, "hotspots":True, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":["n_unique_HLA","unique_peptides","popcov_but_sqrt"]}
...
draw_KM_curve_svm_experiment('surv_base',svm_params={'kernel':'poly'},additional_info={"PRIMARY_TUMOR_ONLY":False,"with_mutations":True,"hotspots":True, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv","HS_features":[]}) 


draw_KM_curve_svm_experiment('surv_pep',svm_params={'kernel':'poly'},additional_info={"PRIMARY_TUMOR_ONLY":False,"with_mutations":True,"hotspots":True, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv","HS_features":['unique_peptides']})

draw_KM_curve_svm_experiment('surv_promis',svm_params={'kernel':'poly'},additional_info={"PRIMARY_TUMOR_ONLY":False,"with_mutations":True,"hotspots":True, "weights":weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv","HS_features":['popcov_but_sqrt']})


#weights = {"PS": 0.1, "TF": 0.1, "CF": 0.1, "BP": 0.1, "MT": 0.1, "GE": 0.1}
draw_KM_curve_svm_experiment('surv_HLA',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":["n_unique_HLA"]})
draw_KM_curve_svm_experiment('surv_HLApep',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":["n_unique_HLA","unique_peptides"]})
draw_KM_curve_svm_experiment('surv_HLApromis',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":["n_unique_HLA","popcov_but_sqrt"]})

draw_KM_curve_svm_experiment('surv_prompep',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":["popcov_but_sqrt","unique_peptides"]})



draw_KM_curve_svm_experiment('surv_3_feat',svm_params={'kernel': 'poly'},
                             additional_info={"PRIMARY_TUMOR_ONLY": False, "with_mutations": True, "hotspots": True,
                                              "weights": weights, "contig_file":"data/Michal_combined_set_14_02_2025.tsv", "HS_features":["n_unique_HLA","unique_peptides","popcov_but_sqrt"]})
